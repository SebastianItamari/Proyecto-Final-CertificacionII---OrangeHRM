...
public class PIMPage extends CommonPage{
    ...
    {
        WebElement addEmployeeButton = new WebDriverWait(driver, Duration.ofSeconds(10))
    ...
    public void setEmployeeNameTextBox(String name){
        WebElement employeeNameTextBox = new WebDriverWait(driver, Duration.ofSeconds(10))
